...
<body>
  ...
  <div id="loginmodal" class="modal center-align">
    ...
    <div class="modal-content">
      <div class="row">
          <form class="col s12 l6" action="core/login.php" method="POST">
              <div class="row">
                  <div class="input-field col s12">
                      <input placeholder="Digite aqui seu usuario" name="usuario" id="usuario" type="text" class="validate">
                      <label for="usuario">Usuario</label>
                  </div>
                  <div class="input-field col s12">
                      <input placeholder="Digite aqui sua senha" name="senha" id="senha" type="password" class="validate">
          ...
          <div class="col s12 l6">
                  ...
                  <p>Inicie utilizando uma conta inteiramente gratuita, você não paga nada e vende muito! A hora é agora!</p>
                   <div class="input-button col s12">
                           <a href="?page=registro" class="btn blue darken-1 waves-effect waves-light" type="button">Criar Agora!
        ...
        <div class="container-fluid">
            ...
            <div class="section red lighten-2">
                <div class="container red lighten-2">
                    <div class="row">
                        <h4 class="center-align white-text">Encontre Produtos</h4>
                         <form class="white">
